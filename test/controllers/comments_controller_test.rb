...
class CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_should_create_comment_for_valid_request
    content = "Wow!"
    post comments_path, params: { comments: { content: content, task_id: @task.id } }, headers: @headers
    assert_response :success
    assert_equal content, @task.comments.last.content
  end

  def test_shouldnt_create_comment_without_content
    post comments_path, params: { comments: { content: "", task_id: @task.id } }, headers: @headers
  ...
  def test_shouldnt_create_comment_without_task
    post comments_path, params: { comments: { content: "This is a comment", task_id: "" } }, headers: @headers
