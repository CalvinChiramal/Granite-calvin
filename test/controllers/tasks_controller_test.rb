...
class TasksControllerTest < ActionDispatch::IntegrationTest
  ...
  def test_should_list_all_tasks_for_valid_user
    ...
    assert_equal pending_tasks_count, all_tasks["pending"].length
    assert_equal completed_tasks_count, all_tasks["completed"].length
  end
  ...
  def test_not_found_error_rendered_for_invalid_task_slug
    ...
    assert_equal t("not_found", entity: "Task"), response.parsed_body["error"]
  end
end
